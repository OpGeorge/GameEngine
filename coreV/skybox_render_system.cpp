...
namespace gen {
    ...
    void SkyboxRenderSystem::createPipeline(VkRenderPass renderPass) {
        ...
        pipelineConfig.rasterizationInfo.cullMode = VK_CULL_MODE_FRONT_BIT; // keep
        pipelineConfig.rasterizationInfo.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE; // try CCW
