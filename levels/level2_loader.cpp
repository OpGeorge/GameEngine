...
namespace gen {
    ...
    void Level2Loader::loadLevel2(GenDevice& genDevice, GenGameObject::Map& gameObjects) {
        ...
        auto texture5 = std::make_shared<GenTexture>(genDevice, "textures/gold.png");
        ...
        vase.transform.translation = { -20.0f, -2.0f, 3.f };
        ...
        // Repeat for other objects like flat vase, cube, lights, etc.
        genModel = GenModel::createModelFromFile(genDevice, "objectmodels/models/Player Model.obj");
        auto flatVase2 = GenGameObject::createGameObject();
        flatVase2.model = genModel;
        flatVase2.transform.translation = { -20.f,0.0f,-7.f };
        flatVase2.transform.scale = glm::vec3(0.4f);
        flatVase2.type = ObjectType::NPC;
        flatVase2.texture = texture4;
        flatVase2.npcBehavior = std::make_unique<NPCBehaviorComponent>();
        flatVase2.tag = "level2_npc_2";
        gameObjects.emplace(flatVase2.getId(), std::move(flatVase2)); // make sure the move has a valid pointer and a not null obj
        ...
        ceilingGoal.transform.translation = { -20.f,-3.5f,-14.5f };
        ...
        genModel = GenModel::createModelFromFile(genDevice, "objectmodels/models/colored_cube.obj");
        auto congratulate = GenGameObject::createGameObject();
        congratulate.model = genModel;
        congratulate.transform.translation = { -20.f,-4.3f, -0.0f };
        congratulate.transform.scale = glm::vec3(0.35f);
        congratulate.texture = texture5;
        congratulate.transform.rotation = glm::vec3(0.f, 0.f,0.f);
        congratulate.type = ObjectType::FinalGoal;
        gameObjects.emplace(congratulate.getId(), std::move(congratulate));
        ...
        auto pointLight = GenGameObject::makePointLight(4.2f, 0.1f);
        pointLight.transform.translation = glm::vec3{ -20.0f,-4.5f,2.0f };
        pointLight.type = ObjectType::Light;
        gameObjects.emplace(pointLight.getId(), std::move(pointLight));

        auto pointLight2 = GenGameObject::makePointLight(4.2f, 0.1f);
        pointLight2.transform.translation = glm::vec3{ -14.0f,-4.5f,2.0f };
        ...
        pointLight3.transform.translation = glm::vec3{ -26.0f,-4.5f,2.0f };
        ...
        pointLight4.transform.translation = glm::vec3{ -20.0f,-4.5f,-3.0f };
        ...
        pointLight5.transform.translation = glm::vec3{ -14.0f,-4.5f,-3.0f };
        ...
        pointLight6.transform.translation = glm::vec3{ -26.0f,-4.5f,-3.0f };
        ...
        pointLight7.transform.translation = glm::vec3{ -20.0f,-4.5f,-7.0f };
        ...
        pointLight8.transform.translation = glm::vec3{ -14.0f,-4.5f,-7.0f };
        ...
        pointLight9.transform.translation = glm::vec3{ -26.0f,-4.5f,-7.0f };
        ...
        wallR.transform.translation = { -27.f,-2.5f,-3.5f };
        ...
        wallL.transform.translation = { -13.f,-2.5f,-3.5f };
        ...
        ceiling.transform.translation = { -20.f,-3.5f,-3.5f };
        ...
        facingWall2.transform.translation = { -30.f,-2.5f,-11.5f };
        ...
        facingWall3.transform.translation = { -20.f,-2.5f,-17.5f };
        ...
        wallLGoal.transform.translation = { -18.f,-2.5f,-19.5f };
        ...
        wallRGoal.transform.translation = { -22.f,-2.5f,-19.5f };
        ...
        backWall.transform.translation = { -20.f,-2.5f,4.5f };
        ...
        pillar.transform.translation = { -20.f,-0.f,-3.5f };
        pillar.transform.scale = glm::vec3(4.f, 1.f, 2.f);
