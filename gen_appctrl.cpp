...
namespace gen {
    ...
    void AppCtrl::run() {
        ...
        GenPointShadowMap shadowMap{ genDevice, glm::vec3(0.0f, 2.0f, 0.0f) };

        SimpleShadowRenderSystem shadowRenderSystem{
                genDevice,
        ...
        while (!genWindow.shouldClose()) {
            ...
            if (auto commandBuffer = genRenderer.beginFrame()) {
                ...
                shadowRenderSystem.renderObjects(commandBuffer, shadowMap, gameObjects);
